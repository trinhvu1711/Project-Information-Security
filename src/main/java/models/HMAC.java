...
public class HMAC {
    ...
    public static void main(String[] args) {
        try {
            ...
            HMAC hmacHashFunction = new HMAC();
            ...
            System.out.println("Key MD5: " + Base64.getEncoder().encodeToString(md5Key.getEncoded()));
            System.out.println("HMAC MD5: " + hmacMD5);
            System.out.println("Key SHA-1: " + Base64.getEncoder().encodeToString(sha1Key.getEncoded()));
