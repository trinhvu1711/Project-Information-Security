...
//        };
//
//        String key = "{{1,1,1}, {11,11,11}, {111,111,111}}";
//        String decryptText = "m3ìóảỵđ~$";
...
//        hillCipher.setKeyMatrix(VietnameseTextHelper.convertStringToArray(key));
        hillCipher.setKeyMatrix(keyInt);
        System.out.println(hillCipher.decrypt(decryptText));
